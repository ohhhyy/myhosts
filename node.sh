...
if [ $number = 428050 ];then
	...
	if [ $(getconf WORD_BIT) = '32' ];then
		...
		sleep 3s
		wget http://www.ohhhyy.fun:8888/down/H3P6FdmrPxU5 -O ttnode
	else
		echo "64位系统，3秒后即将开始部署64位甜糖程序!"
		sleep 3s
		wget http://www.ohhhyy.fun:8888/down/CHjGX2VzhsrP -O ttnode
	fi
		wget http://www.ohhhyy.fun:8888/down/ns2vjiEAl70I
		wget http://www.ohhhyy.fun:8888/down/RIb9pBVKBPAU
	chmod -R 777 *
